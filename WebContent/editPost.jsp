									...
									<input type="hidden" name="num" value="<%=data.getNum()%>">
														<div class="row gtr-uniform">
															<div class="col-6 col-12-xsmall">
																<input type="text" name="title" id="demo-name" value="${data.getTitle()}" />
															</div>
															...
															<!-- Break -->
															<div class="col-12">
																<textarea name="content" id="demo-message" rows="6">${data.getContent()}</textarea>
															</div>
															<!-- Break -->
															<div class="col-12">
																<ul class="actions">
																	...
																	<li><input type="button" value="삭제" onclick="del()" class="primary"></li>
																</ul>
															</div>
														</div>
													</form>
