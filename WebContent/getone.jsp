							...
							<section id="one">
								<div class="inner">
									...
									<%if(data.getId().equals(user.getId())){ %>
										<button class="button" onclick="location.href='controlBoard.jsp?action=edit1&num=<%=data.getNum()%>'">수정하기</button>
									<%} %> <button class="button" onclick="gogo()">뒤로가기</button><br><br>
