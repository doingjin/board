...
public class BoardDAO {
	...
	String SQL_SEARCH="SELECT * FROM BOARD WHERE ? LIKE ? ORDER BY NUM DESC";
	String SQL_SELECTMINE="SELECT * FROM BOARD WHERE ID=? ORDER BY NUM DESC";
	...
	// SQL_SELECTALL="SELECT * FROM BOARD WHERE ? LIKE %?% ORDER BY NUM DESC"
	...
	// SQL_SELECTALL="SELECT * FROM BOARD WHERE ? LIKE %?% ORDER BY NUM DESC"
		public ArrayList<BoardVO> searchBoard(String ctgr, String search){
			ArrayList<BoardVO> datas=new ArrayList();
			conn=JDBC.connect();
			try {
				pstmt=conn.prepareStatement("SELECT * FROM BOARD WHERE "+ctgr+" LIKE '%"+search+"%' ORDER BY NUM DESC");
	...
	// SQL_SELECTMINE="SELECT * FROM BOARD WHERE ID=? ORDER BY NUM DESC"
	public ArrayList<BoardVO> getMyList(BoardVO vo){
		ArrayList<BoardVO> datas=new ArrayList();
		conn=JDBC.connect();
		try {
